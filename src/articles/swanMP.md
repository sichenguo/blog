...
- 开发体验
  我是 18 年初的时候开始接触小程序，刚开始是做 PC 端开发，嗯，后来因为~~老大一声令下~~业务拓展的关系开始了小程序的 漫漫踩坑路，截止到现在小程序也做很多。其中的有在上家单位开发的企鹅洗衣小程序，还有目前在维护的青团社兼职小程序（偷偷打个广告）。emm,小程序里面常见的功能基本上都是有过 一些了解的,怎么也算是~~踩坑~~经验丰富了吧 🤣。
